...
- (void)addNavSwitch
{
    CYLNavSwitch *navSwitch = [CYLNavSwitch navSwitchWithNameArray:self.switchTitleArray andNotificationPrefix:nil delegate:self];
...
{
    [CYLNavSwitch postNotificationWithScrollView:scrollView delegate:self];
}
